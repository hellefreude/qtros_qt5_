...
bool QNode::init() {
    ...
    //arm_module
    arm_displacement_pub = n.advertise<ssoni_arm_module_msgs::ArmCmd>("/heroehs/arm/displacement",1);
    ...
    //people
    g_people_position_pub =  n.advertise<ssoni_perception_msgs::PeoplePositionArray>("/ssoni/people_position", 1);

    //haed module
    head_gui_motor_publisher = n.advertise<std_msgs::Float64MultiArray>("/ssoni/head_ctrl", 1);
    head_gui_manual_publisher = n.advertise<std_msgs::Bool>("/ssoni/head_manual", 1);
    head_gui_tracking_publisher= n.advertise<std_msgs::Bool>("/ssoni/head_tracking", 1);
